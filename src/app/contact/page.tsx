        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <nav className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-6">
              ...
              <a href="/terms-of-service" className="text-gray-600 hover:text-purple-600 transition-colors">
                ...
                <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl p-6">
                  <div className="flex items-center mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-purple-600 font-medium">support@zoba.com</p>
                      <p className="text-purple-600 font-medium">contact@zoba.com</p>
                    </div>
                  </div>

...
-- CreateEnum
CREATE TYPE "public"."ChannelType" AS ENUM ('FACEBOOK_PAGE', 'INSTAGRAM_DM', 'WHATSAPP', 'TELEGRAM', 'TIKTOK', 'EMAIL');

-- CreateEnum
CREATE TYPE "public"."OrderStatus" AS ENUM ('PENDING', 'CONFIRMED', 'PROCESSING', 'SHIPPED', 'DELIVERED', 'CANCELLED', 'RETURNED');

-- CreateEnum
CREATE TYPE "public"."PaymentStatus" AS ENUM ('PENDING', 'PAID', 'FAILED', 'REFUNDED', 'PARTIAL');

-- CreateEnum
CREATE TYPE "public"."ConversationPriority" AS ENUM ('LOW', 'NORMAL', 'HIGH', 'URGENT');

-- CreateEnum
CREATE TYPE "public"."ConversationStatus" AS ENUM ('OPEN', 'PENDING', 'RESOLVED', 'CLOSED', 'ARCHIVED');

-- CreateEnum
CREATE TYPE "public"."MessageType" AS ENUM ('TEXT', 'IMAGE', 'AUDIO', 'VIDEO', 'DOCUMENT', 'LOCATION', 'CONTACT', 'STICKER', 'SYSTEM');
...
CREATE TABLE "public"."Conversation" (
    "id" UUID NOT NULL,
    "title" TEXT,
    "platform" "public"."ChannelType" NOT NULL,
    "externalId" TEXT,
    "isActive" BOOLEAN NOT NULL DEFAULT true,
...
-- CreateIndex
CREATE UNIQUE INDEX "Channel_shopId_type_externalId_key" ON "public"."Channel"("shopId", "type", "externalId");

-- CreateIndex
CREATE UNIQUE INDEX "Category_shopId_name_key" ON "public"."Category"("shopId", "name");

-- CreateIndex
CREATE UNIQUE INDEX "Product_shopId_sku_key" ON "public"."Product"("shopId", "sku");

-- CreateIndex
CREATE UNIQUE INDEX "Customer_shopId_phone_key" ON "public"."Customer"("shopId", "phone");

-- CreateIndex
CREATE UNIQUE INDEX "Order_shopId_orderNumber_key" ON "public"."Order"("shopId", "orderNumber");

-- CreateIndex
CREATE UNIQUE INDEX "Conversation_orderId_key" ON "public"."Conversation"("orderId");

-- CreateIndex
CREATE UNIQUE INDEX "Conversation_shopId_platform_externalId_key" ON "public"."Conversation"("shopId", "platform", "externalId");
...
-- AddForeignKey
ALTER TABLE "public"."Shop" ADD CONSTRAINT "Shop_ownerId_fkey" FOREIGN KEY ("ownerId") REFERENCES "public"."Profile"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."Channel" ADD CONSTRAINT "Channel_shopId_fkey" FOREIGN KEY ("shopId") REFERENCES "public"."Shop"("id") ON DELETE CASCADE ON UPDATE CASCADE;
